...
Public Function CompareArrays(ByVal Array1 As Variant, ByVal Array2 As Variant, _
    ByVal ResultArray As Variant, Optional CompareMode As VbCompareMethod = vbTextCompare) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CompareArrays
...
Public Function ConcatenateArrays(ByVal ResultArray As Variant, ByVal ArrayToAppend As Variant, _
        Optional ByVal NoCompatabilityCheck As Boolean = False) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ConcatenateArrays
...
Public Function CopyArray(ByVal DestinationArray As Variant, ByVal SourceArray As Variant, _
        Optional ByVal NoCompatabilityCheck As Boolean = False) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CopyArray
...
Public Function CopyArraySubSetToArray(ByVal InputArray As Variant, ByVal ResultArray As Variant, _
    ByVal FirstElementToCopy As Long, ByVal LastElementToCopy As Long, ByVal DestinationElement As Long) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CopyArraySubSetToArray
...
Public Function CopyNonNothingObjectsToArray(ByVal SourceArray As Variant, _
    ByVal ResultArray As Variant, Optional ByVal NoAlerts As Boolean = False) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CopyNonNothingObjectsToArray
...
Public Function DataTypeOfArray(ByVal arr As Variant) As VbVarType
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' DataTypeOfArray
'
...
Public Function DeleteArrayElement(ByVal InputArray As Variant, ByVal ElementNumber As Long, _
    Optional ByVal ResizeDynamic As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' DeleteArrayElement
...
Public Function FirstNonEmptyStringIndexInArray(ByVal InputArray As Variant) As Long
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' FirstNonEmptyStringIndexInArray
...
Public Function InsertElementIntoArray(ByVal InputArray As Variant, ByVal Index As Long, _
...
Public Function IsArrayAllDefault(ByVal InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayAllEmpty
...
Public Function IsArrayAllNumeric(ByVal arr As Variant, _
    Optional ByVal AllowNumericStrings As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayAllNumeric
...
Public Function IsArrayDynamic(ByVal arr As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayDynamic
...
Public Function IsArrayObjects(ByVal InputArray As Variant, _
    Optional ByVal AllowNothing As Boolean = True) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayObjects
...
Public Function IsNumericDataType(ByVal TestVar As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsNumericDataType
'
...
Public Function IsVariantArrayConsistent(ByVal arr As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsVariantArrayConsistent
'
...
Public Function IsVariantArrayNumeric(ByVal TestArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsVariantArrayNumeric
'
...
Public Function MoveEmptyStringsToEndOfArray(ByVal InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function NumberOfArrayDimensions(ByVal arr As Variant) As Integer
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' NumberOfArrayDimensions
...
Public Function NumElements(ByVal arr As Variant, Optional ByVal Dimension As Long = 1) As Long
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' NumElements
...
Public Function ReverseArrayInPlace(ByVal InputArray As Variant, _
...
Public Function ReverseArrayOfObjectsInPlace(ByVal InputArray As Variant, _
    Optional ByVal NoAlerts As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ReverseArrayOfObjectsInPlace
' This procedure reverses the order of an array in place -- this is, the array variable
...
Public Function SetObjectArrayToNothing(ByVal InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function AreDataTypesCompatible(ByVal DestVar As Variant, ByVal SourceVar As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' AreDataTypesCompatible
...
Public Function TransposeArray(ByVal InputArr As Variant, ByVal OutputArr As Variant) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' TransposeArray
...
Public Function VectorsToArray(ByVal arr As Variant, ParamArray Vectors()) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' VectorsToArray
...
Public Function ChangeBoundsOfArray(ByVal InputArr As Variant, _
    ByVal NewLowerBound As Long, ByVal NewUpperBound As Long) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ChangeBoundsOfArray
...
Public Function IsArraySorted(ByVal TestArray As Variant, _
...
Public Function CombineTwoDArrays(ByVal Arr1 As Variant, _
...
Public Function ExpandArray(ByVal arr As Variant, ByVal WhichDim As Long, ByVal AdditionalElements As Long, _
        ByVal FillValue As Variant) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ExpandArray
...
Public Function SwapArrayRows(ByVal arr As Variant, ByVal Row1 As Long, ByVal Row2 As Long) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' SwapArrayRows
...
Public Function SwapArrayColumns(ByVal arr As Variant, ByVal Col1 As Long, ByVal Col2 As Long) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' SwapArrayColumns
...
Public Function GetColumn(ByVal arr As Variant, ByVal ResultArr As Variant, ByVal ColumnNumber As Long) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' GetColumn
...
Public Function GetRow(ByVal arr As Variant, ByVal ResultArr As Variant, ByVal RowNumber As Long) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' GetRow
' This populates ResultArr with a one-dimensional array that is the
